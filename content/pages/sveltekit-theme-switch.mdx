...
When adding **dark mode** to my new [SvelteKit](https://kit.svelte.dev) project, I ran into a few issues when creating the **theme switch**. In this guide, I would like to share the solution I came up with.
