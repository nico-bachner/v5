...
export const InfoCard: React.VFC<InfoCardProps> = ({
  ...
  <Link href={href}>
    <a className="flex transform flex-col gap-2 rounded-lg border border-white/20 bg-white/25 p-6 shadow-lg backdrop-blur-sm dark:border-zinc-600/20 dark:bg-zinc-600/25 md:gap-4 md:p-10 md:transition md:duration-300 md:hover:scale-105 md:hover:shadow-xl lg:gap-6 lg:p-12">
