...
export const InfoCard: React.VFC<InfoCardProps> = ({
  ...
  <Link href={href}>
    <a className="flex transform flex-col gap-4 rounded-lg border border-white/20 bg-white/25 p-6 shadow-lg backdrop-blur-sm transition-all duration-300 md:p-10 md:hover:scale-105 md:hover:shadow-xl lg:p-12">
